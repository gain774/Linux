...
PLAN = Plan(
    ...
    walls=[
        ...
        (E, DOMA, W, DOMA),      # 12 土間 / 納戸
    ],
    openings=[
        # 玄関（南）
        Opening(0, 9.0, 0.95, 'door', swing='right'),
        # LDK の窓（南に2、西に1）
        ...
        # 廊下から各室へ
        Opening(11, 1.0, 0.9, 'door', swing='left'),    # 玄関 → 廊下
        ...
        Opening(12, 1.8, 0.85, 'door', swing='left'),   # 土間 → 納戸
    ],
    rooms=[
        Room('LDK',      [(0, 0), (E, 0), (E, COR_S), (0, COR_S)]),
        Room('玄関土間',  [(E, 0), (W, 0), (W, DOMA), (E, DOMA)]),
        Room('納戸',     [(E, DOMA), (W, DOMA), (W, COR_S), (E, COR_S)]),
